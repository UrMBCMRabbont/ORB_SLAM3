...
public:
    ...
    cv::Mat TrackStereo_cv(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp, const vector<IMU::Point>& vImuMeas = vector<IMU::Point>(), string filename="");
    ...
    FrameDrawer*  GetmpFrameDrawer();//return frameDrawer
    const vector<MapPoint*> GetmpMapAllMapPoints();
